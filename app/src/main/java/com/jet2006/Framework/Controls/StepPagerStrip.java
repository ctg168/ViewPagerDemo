package com.jet2006.Framework.Controls;
...
public class StepPagerStrip extends View {
    ...
    public StepPagerStrip(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int width = View.resolveSize((int) (mPageCount * (mTabWidth + mTabSpacing) - mTabSpacing)
                + getPaddingLeft() + getPaddingRight(), widthMeasureSpec);
        int height = View.resolveSize((int) mTabHeight + getPaddingTop() + getPaddingBottom(),
                heightMeasureSpec);
